...
{
	/* The ScheduledTime class models a timer that goes off at one of several fixed rates like monthly, daily, weekly or hourly. 
     * It makes it easier to schedule things on a more human oriented rate, like at 6:00 AM every Thursday.
     */
