...
{
    /* EventQueue takes several schedules and provides the union of them. 
     * So if you need to execute an event every day at 5:00 AM and 7:00 PM, you could create schedules for the two events and add them both to an EventQueue object.
     */
