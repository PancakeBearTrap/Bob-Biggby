...
{
    /* BlockWrapper is a scheduler for a very specific operation.
     * It limits another schedule to only fire within a repeating range of time. 
     * This is used primarily to manage something that will only run on weekdays, weekends or only during business hours.
     */
    /// <summary>
